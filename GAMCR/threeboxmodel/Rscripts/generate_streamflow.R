...
setwd("/home/duchemin/Desktop/data_watres/benchmark/")  # change this to wherever the data file and called scripts are
...
sourceCpp("/home/duchemin/Desktop/data_watres/benchmark/code/threebox_v1.15_for_Rcpp.cpp")  #this is the benchmark model code (water flux module)
sourceCpp("/home/duchemin/Desktop/data_watres/benchmark/code/threebox_tracers_v1.0_for_Rcpp.cpp")  #this is the benchmark model code (solute tracer module)
sourceCpp("/home/duchemin/Desktop/data_watres/benchmark/code/threebox_age_tracking_perso_correct.cpp")  #this is the benchmark model code (age tracking module)


options(digits=7)
STATION = '2199'
if (STATION=='81'){
  dat <- fread("/home/duchemin/Desktop/data_watres/benchmark/flow/calibration_PSL_simulatedata/dataQuentin/GISID-81_BAFU-2432.csv", header=TRUE, sep=",", na.strings=c("NA",".","","#N/A"))    #this is the test data file
}
if (STATION=='58'){
  dat <- fread("/home/duchemin/Desktop/data_watres/benchmark/flow/calibration_PSL_simulatedata/dataQuentin/GISID-58_BAFU-2349.csv", header=TRUE, sep=",", na.strings=c("NA",".","","#N/A"))    #this is the test data file
}
if (STATION=='Sion'){
  dat <- fread("/home/duchemin/Desktop/data_watres/benchmark/flow/3_long_stations/Sion.csv", header=TRUE, sep=",", na.strings=c("NA",".","","#N/A"))    #this is the test data file
}

if (STATION=='2199'){
    dat <- fread("/home/duchemin/Desktop/data_watres/benchmark/flow/calibration_PSL_simulatedata/dataQuentin/GISID-25_BAFU-2199.csv", header=TRUE, sep=",", na.strings=c("NA",".","","#N/A"))    #this is the test data file
}

dir.create(file.path('/home/duchemin/Desktop/data_watres/benchmark/flow/calibration_PSL_simulatedata/', paste0(STATION, "_flashy_new", collapse=NULL)), showWarnings = FALSE);


path_save = paste0('/home/duchemin/Desktop/data_watres/benchmark/flow/calibration_PSL_simulatedata/', paste0(STATION, "_flashy_new/", collapse=NULL), collapse=NULL);
...
if (STATION=='81'){ # using calibrated parameters from site with GISID 81
...
if (STATION=='58'){ # using calibrated parameters from site with GISID 58
  bu <- 50.      # upper box drainage exponent
...
if (STATION=='old_Sion'){
  ...
  f_SS <- 0.3       # fraction of discharge in reference state from shallow subsurface flow
}
...
filename = paste0(path_save, "ref_flow_flashy_new_fluxes.txt", collapse=NULL);
